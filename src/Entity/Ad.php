...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre description est trop courte, 100 caractères minimum requis")
     */
    private $content;
    ...
    /**
     * Get an ad's comment from an author if exists
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Return an array of days already booked
     *
     * @return array
     */
