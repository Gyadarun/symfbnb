    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add(
                'title',
                TextType::class, 
                $this->getConfiguration("Titre", "Tappez un titre pour votre annonce")
                )
            ->add(
                'slug', 
                TextType::class, 
                $this->getConfiguration("Adresse web", "Tappez l'adresse", [
                    'required' => false
                    ])
                )
            ->add(
            ...
            ->add(
                'content', 
                TextareaType::class, 
                $this->getConfiguration("Description détaillée", "Tappez une description qui donne envie de venir chez vous !" )
                )
            ->add(
                'rooms', 
                IntegerType::class, 
